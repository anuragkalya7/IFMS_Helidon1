...
//			}
			...
			while (rs.next()) {
				...
				System.out.println(roleList.get(0) + " - ROLE 1");
				userDetails = new UserDetails(ssoid, Integer.parseInt((String) jsonObject.get("user_id")), (String) jsonObject.get("user_type"),
						roleList);
				break;
			}
